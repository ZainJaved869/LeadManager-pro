...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-slate-200/60 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200/60">
            <h1 class="text-xl font-semibold text-slate-800">Add New Lead</h1>
            <p class="text-sm text-slate-500">Fill in the details below to create a new lead.</p>
        </div>
        <div class="p-6">
            <form method="POST" action="{{ route('leads.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="contacted_at" id="contacted_at" value="{{ old('contacted_at') }}"
                               class="mt-1 w-full rounded-lg border-slate-300 focus:border-yellow-500 focus:ring-yellow-500">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="lost_reason" id="lost_reason" rows="3"
                              class="mt-1 w-full rounded-lg border-slate-300 focus:border-yellow-500 focus:ring-yellow-500"
                              placeholder="Why was this lead lost? (budget, competitor, etc.)">{{ old('lost_reason') }}</textarea>
